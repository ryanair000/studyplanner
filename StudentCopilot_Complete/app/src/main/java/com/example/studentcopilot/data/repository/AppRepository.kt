...
class AppRepository(
    ...
    fun getAllCourses(): Flow<List<Course>> {
        return courseDao.getAllCourses().mapToModel()
    }
...
// Extension function to map Room entities to domain models
private fun Flow<List<CourseEntity>>.mapToModel(): Flow<List<Course>> {
